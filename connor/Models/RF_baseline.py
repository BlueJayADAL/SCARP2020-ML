...
from sklearn import linear_model, preprocessing, svm, neighbors, neural_network
...
def main ():
    ...
    parser.add_argument('integers', type = int, help="{How many Times should we run this program?")
    ...
    if args.dataset == None or not os.path.isdir(args.dataset) or args.anno == None:
        ...
        print("Please choose a value above 0")
        return
    ...
    for x in range(num_runs):
        ...
        clf = clf = RandomForestClassifier(n_estimators=100, max_depth=None, min_samples_split=2, min_samples_leaf=1,
                                           max_features=None, n_jobs=8, verbose=1)
